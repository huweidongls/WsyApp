...
public class YinsizhengceActivity extends BaseActivity {
    ...
    private Context context = YinsizhengceActivity.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StatusBarUtils.setStatusBar(YinsizhengceActivity.this, getResources().getColor(R.color.white_ffffff));
        ButterKnife.bind(YinsizhengceActivity.this);
        initWebView();
...
//                }
        ...
        String url = "http://hvc.jiufangkeji.com/policy/privacy_policy.html";
        webview.loadUrl(url);
