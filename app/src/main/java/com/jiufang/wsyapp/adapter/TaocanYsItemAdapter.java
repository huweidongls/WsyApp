...
import com.jiufang.wsyapp.ui.YsTaocanDetailsActivity;
...
public class TaocanYsItemAdapter extends RecyclerView.Adapter<TaocanYsItemAdapter.ViewHolder> {

    private Context context;
    private List<GetComboCategoryListBean.DataBean.ComboVoListBean> data;

    public TaocanYsItemAdapter(List<GetComboCategoryListBean.DataBean.ComboVoListBean> data) {
        this.data = data;
    }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.recyclerview_taocan_ys_item, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.setClass(context, YsTaocanDetailsActivity.class);
